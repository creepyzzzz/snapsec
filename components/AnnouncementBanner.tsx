...
const AnnouncementBanner: React.FC = () => {
    ...
    return (
        <div className="w-full flex justify-center pt-2 pb-1 relative z-[60] bg-white dark:bg-black">
            <div
                className="w-[95%] max-w-6xl bg-gradient-to-r from-blue-600/10 via-blue-500/5 to-indigo-600/10 dark:from-blue-900/25 dark:via-blue-800/15 dark:to-indigo-900/25 backdrop-blur-2xl border border-blue-500/15 dark:border-blue-400/15 rounded-full py-1 px-10 text-[12px] md:text-[13px] font-medium text-zinc-700 dark:text-blue-100 flex items-center justify-center gap-6 transition-all duration-500 cursor-pointer group relative overflow-hidden shadow-[0_4px_20px_-10px_rgba(37,99,235,0.15)] hover:shadow-[0_8px_30px_-10px_rgba(37,99,235,0.25)] hover:border-blue-500/30"
            ...
            >
                ...
                <div className="flex items-center gap-3 relative z-10 flex-grow justify-center overflow-hidden">
                    <div className="w-1.5 h-1.5 bg-blue-500 animate-pulse shadow-[0_0_8px_rgba(37,99,235,0.4)] flex-shrink-0" />
                    <span className="tracking-tight truncate">
                        {BANNER_CONFIG.text.split("See the")[0]}
                        <span className="text-blue-600 dark:text-blue-400 font-bold ml-1">See the 2026 State of Autonomous Protection.</span>
                    </span>
                    <ArrowRight className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 transition-transform flex-shrink-0" />
                </div>

                <div className="w-[1px] h-3 bg-blue-500/10 relative z-10" />

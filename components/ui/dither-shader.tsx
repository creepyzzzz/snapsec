        ...
        (
            ...
            for (let y = 0; y < displayHeight; y += effectivePixelSize) {
                for (let x = 0; x < displayWidth; x += effectivePixelSize) {
                    ...
                    if (animated) {
                        // Add subtle wave animation to make it feel alive
                        // Sine wave moving diagonally with time
                        const wave = Math.sin(x * 0.02 + y * 0.02 + time * 10) * 0.02;
                        ditherThreshold += wave;
                    }

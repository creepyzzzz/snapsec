...
const FeatureList: React.FC = () => {
    return (
        <section className="py-16 md:py-24 bg-white dark:bg-black border-t border-zinc-200 dark:border-zinc-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12 md:gap-16 relative">
                ...
                <div className="lg:w-1/3 relative z-10">
                    ...
                    >
                        ...
                        <div className="absolute -left-10 md:-left-20 -top-20 w-[400px] md:w-[600px] h-[400px] md:h-[600px] pointer-events-none opacity-30 -z-10">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-[34px] font-medium text-zinc-950 dark:text-white mb-2 leading-tight">Better decisions.</h2>
                            <h2 className="text-3xl md:text-[34px] font-medium text-zinc-950 dark:text-white mb-2 leading-tight">Faster outcomes.</h2>
                            <h2 className="text-3xl md:text-[34px] font-medium bg-gradient-to-r from-blue-600 to-white dark:from-blue-400 dark:to-white bg-clip-text text-transparent mb-6 md:mb-8 leading-tight">Not more alerts.</h2>

                            <p className="text-zinc-600 dark:text-zinc-500 text-sm md:text-base leading-relaxed max-w-xs md:max-w-sm">
                ...
                <div className="lg:w-2/3 flex flex-col gap-6 relative z-10">
                    ...
                    <motion.div 
                        ...
                        className="relative rounded-[24px] p-6 md:p-8 overflow-hidden shadow-[0_3px_6px_rgba(0,0,0,0.1),0_11px_11px_rgba(0,0,0,0.09),0_26px_15px_rgba(0,0,0,0.05),0_46px_18px_rgba(0,0,0,0.01)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-blue-100 dark:border-zinc-800"
                    >
                        {/* Background Gradient */}

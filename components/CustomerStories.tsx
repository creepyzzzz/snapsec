        ...
        <section className="py-24 bg-white dark:bg-black border-t border-zinc-200 dark:border-zinc-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h3 className="text-sm text-zinc-950 dark:text-white font-medium">Secure APIs and ship faster</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="group relative h-[400px] rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                        ...
                        <div className="absolute bottom-0 left-0 p-8">
                            ...
                            <div>
                                <div className="text-[10px] text-zinc-600 dark:text-zinc-400 font-medium">Security Engineering Lead.</div>
                                <div className="text-[10px] text-zinc-400 dark:text-zinc-600">Application Security Team at a fast-casual dining chain with over 3,500 locations</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group relative h-[400px] rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                        ...
                        <div className="absolute bottom-0 left-0 p-8">
                            ...
                            <div>
                                <div className="text-[10px] text-zinc-600 dark:text-zinc-400 font-medium">Senior Security Engineering Manager.</div>
                                <div className="text-[10px] text-zinc-400 dark:text-zinc-600">Application Security Team at a leading Cryptocurrency Exchange Platform</div>
                            </div>
                        </div>
                    </div>
                </div>
